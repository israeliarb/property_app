...
import 'package:property_app/screens/item_responsible_page.dart';
        ...
        children: [
          ...
          Padding(
            padding: const EdgeInsets.only(
              left: SpacingSizes.l_32,
              right: SpacingSizes.l_32,
            ),
            child: Container(
                        ...
                        return Expanded(
                          child: ListView.builder(
                            ...
                            itemBuilder: (context, index) {
                              final document = filteredItems.elementAt(index);
                              return SizedBox(
          ...
          SizedBox(
            ...
            child: ElevatedButton(
              onPressed: () {
                if (selectedItem == null) {
                  ...
                  Navigator.push(
                    context,
                    MaterialPageRoute(
                      builder: (context) => ItemEditPage(itemId: selectedItem!),
                    ),
                  );
                }
              },
              ...
              child: const Text('Editar item', style: TextStyle(fontSize: 18)),
            ),
          ),
          const SizedBox(height: 16),
          SizedBox(
